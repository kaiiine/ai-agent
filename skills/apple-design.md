---
name: apple-design
description: Redesigns and restyles an existing interface with Apple's craft: fluid physical motion, springs, damping, gesture response, drag, swipe, sheets, momentum, interruptible transitions, backdrop-filter translucency, depth, optical typography, tracking, leading, reduced-motion, polish. Use when redoing the look and feel of a site.
aliases: [apple, hig, fluid-interfaces, ios-design, apple design]
scope: coding
---

# Apple Design

> **Se combine, ne remplace pas.** Ce skill dit COMMENT le mouvement et la
> matière doivent se comporter ; il ne dit ni quoi installer ni comment
> scaffolder. Sur un projet Next.js, React ou Svelte, charge D'ABORD le skill de
> stack (`nextjs`, `frontend`…) pour les librairies et la structure, puis
> celui-ci pour la qualité du rendu. Là où le skill de stack propose un `tween` à
> durée fixe pour une entrée au scroll, il a raison — les règles de ressort
> ci-dessous visent ce que l'utilisateur peut SAISIR : drag, swipe, sheet,
> reprise en vol.
