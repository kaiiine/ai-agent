...
description: Performance analysis and optimization specialist. Profiling, memory leaks, render optimization, and algorithmic improvements.
aliases: [performance, performances, lent, lenteur, optimisation, latence, profiling]
scope: coding
---
