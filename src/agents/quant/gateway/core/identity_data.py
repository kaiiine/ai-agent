...
TEAMS: list[CanonicalEntity] = [
    ...
    # ── Clubs des saisons historiques 2023-24 et 2024-25 ──────────────────────
    # Relégués depuis, donc absents du roster courant — mais bien présents dans
    # le corpus acquis. Sans eux, 22 % des matchs historiques étaient écartés à
    # la résolution : 1364 rencontres réelles perdues sur les sept ligues.
    #
    # Seul l'identifiant  est renseigné : c'est celui qui a
    # été VÉRIFIÉ dans les fixtures acquises. Deviner un identifiant api_sports
    # pour compléter la paire serait une fabrication.
    CanonicalEntity("team:football:deu:bochum", "Bochum", ['Bochum', 'VfL Bochum 1848'],
                    {"football_data_org": "36"}),
    CanonicalEntity("team:football:deu:darmstadt", "Darmstadt", ['Darmstadt', 'SV Darmstadt 98'],
                    {"football_data_org": "55"}),
    CanonicalEntity("team:football:deu:holstein_kiel", "Holstein Kiel", ['Holstein Kiel'],
                    {"football_data_org": "720"}),
    CanonicalEntity("team:football:eng:cardiff", "Cardiff", ['Cardiff', 'Cardiff City FC'],
                    {"football_data_org": "715"}),
    CanonicalEntity("team:football:eng:huddersfield", "Huddersfield", ['Huddersfield', 'Huddersfield Town AFC'],
                    {"football_data_org": "394"}),
    CanonicalEntity("team:football:eng:luton_town", "Luton Town", ['Luton Town', 'Luton Town FC'],
                    {"football_data_org": "389"}),
    CanonicalEntity("team:football:eng:plymouth_arg", "Plymouth Arg", ['Plymouth Arg', 'Plymouth Argyle FC'],
                    {"football_data_org": "1138"}),
    CanonicalEntity("team:football:eng:rotherham_utd", "Rotherham Utd", ['Rotherham United FC', 'Rotherham Utd'],
                    {"football_data_org": "385"}),
    CanonicalEntity("team:football:esp:almeria", "Almería", ['Almería', 'UD Almería'],
                    {"football_data_org": "267"}),
    CanonicalEntity("team:football:esp:cadiz", "Cádiz CF", ['Cádiz CF'],
                    {"football_data_org": "264"}),
    CanonicalEntity("team:football:esp:granada", "Granada", ['Granada', 'Granada CF'],
                    {"football_data_org": "83"}),
    CanonicalEntity("team:football:esp:las_palmas", "Las Palmas", ['Las Palmas', 'UD Las Palmas'],
                    {"football_data_org": "275"}),
    CanonicalEntity("team:football:esp:leganes", "Leganés", ['CD Leganés', 'Leganés'],
                    {"football_data_org": "745"}),
    CanonicalEntity("team:football:esp:valladolid", "Valladolid", ['Real Valladolid CF', 'Valladolid'],
                    {"football_data_org": "250"}),
    CanonicalEntity("team:football:fra:clermont_foot", "Clermont Foot", ['Clermont Foot', 'Clermont Foot 63'],
                    {"football_data_org": "541"}),
    CanonicalEntity("team:football:fra:montpellier", "Montpellier", ['Montpellier', 'Montpellier HSC'],
                    {"football_data_org": "518"}),
    CanonicalEntity("team:football:fra:saint_etienne", "Saint-Étienne", ['AS Saint-Étienne', 'Saint-Étienne'],
                    {"football_data_org": "527"}),
    CanonicalEntity("team:football:fra:stade_de_reims", "Stade de Reims", ['Stade de Reims'],
                    {"football_data_org": "547"}),
    CanonicalEntity("team:football:ita:empoli", "Empoli", ['Empoli', 'Empoli FC'],
                    {"football_data_org": "445"}),
    CanonicalEntity("team:football:ita:frosinone", "Frosinone", ['Frosinone', 'Frosinone Calcio'],
                    {"football_data_org": "470"}),
    CanonicalEntity("team:football:ita:monza", "Monza", ['AC Monza', 'Monza'],
                    {"football_data_org": "5911"}),
    CanonicalEntity("team:football:ita:salernitana", "Salernitana", ['Salernitana', 'US Salernitana 1919'],
                    {"football_data_org": "455"}),
    CanonicalEntity("team:football:ita:venezia", "Venezia FC", ['Venezia FC'],
                    {"football_data_org": "454"}),
    CanonicalEntity("team:football:nld:almere_city", "Almere City", ['Almere City', 'Almere City FC'],
                    {"football_data_org": "1911"}),
    CanonicalEntity("team:football:nld:rkc", "RKC", ['RKC', 'RKC Waalwijk'],
                    {"football_data_org": "683"}),
    CanonicalEntity("team:football:nld:vitesse", "Vitesse", ['SBV Vitesse', 'Vitesse'],
                    {"football_data_org": "679"}),
    CanonicalEntity("team:football:nld:willem_ii", "Willem II", ['Willem II', 'Willem II Tilburg'],
                    {"football_data_org": "672"}),
    CanonicalEntity("team:football:prt:boavista", "Boavista", ['Boavista', 'Boavista FC'],
                    {"football_data_org": "810"}),
    CanonicalEntity("team:football:prt:chaves", "Chaves", ['Chaves', 'GD Chaves'],
                    {"football_data_org": "1103"}),
    CanonicalEntity("team:football:prt:farense", "Farense", ['Farense', 'SC Farense'],
                    {"football_data_org": "5602"}),
    CanonicalEntity("team:football:prt:portimonense", "Portimonense", ['Portimonense', 'Portimonense SC'],
                    {"football_data_org": "5601"}),
    CanonicalEntity("team:football:prt:vizela", "Vizela", ['FC Vizela', 'Vizela'],
                    {"football_data_org": "5589"}),
]
